...
- Заголовок revert-коммита (как в `git log --oneline -1` после revert): `#TODO`
...
[FIXME: когда безопасен revert, когда уместен reset --hard на локальной ветке, что происходит с историей для коллег после push.]
